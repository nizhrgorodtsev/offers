...
<div class="card forms">
	<div class="card-header d-flex align-items-center">
		<h3 class="h4" data-objectid="<?php echo $_GET['id']; ?>">Новий об'єкт</h3>
	</div>
	<div class="card-body">
		<form class="form-horizontal" action="<?php echo $objects->actionLink('actionaddobject'); ?>" method="post" enctype= "multipart/form-data">
			...
			<div class="form-group row">
				...
				<div class="col-sm-9  select">
					<select multiple="" name="type"  class="form-control" size="3" required>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<div class="row">
						<div class="col-md-3">
							<input type="text" name="total_area"  placeholder="" class="form-control" value="" >
							<small class="help-block-none">Загальна площа <span>*</span></small>
						</div>
						<div class="col-md-3">
							<input type="text" name="living_area"  placeholder="" class="form-control" value="">
							<small class="help-block-none">Житлова площа <span>*</span></small>
						</div>
						<div class="col-md-3">
							<input type="text" name="kitchen_area"  placeholder="" class="form-control" value="">
							<small class="help-block-none">Площа кухні <span>*</span></small>
						</div>
						<div class="col-md-3">
							<input type="text" name="land_area" placeholder="" class="form-control" value="">
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<div class="row">
						<div class="col-md-4">
							<input type="text" name="wall" placeholder="" class="form-control" value="">
							<small class="help-block-none">Тип стін </small>
						</div>
						<div class="col-md-4">
							<input type="text" name="decoration" placeholder="" class="form-control" value="">
							<small class="help-block-none">Стан ремонту </small>
						</div>
						<div class="col-md-4">
							<input type="date" name="year" placeholder="" class="form-control" value="">
							<small class="help-block-none">Дата будівниуцтва </small>
						</div>					
					</div>
					<div class="row mt-3">
						<div class="col-md-2">
							<input type="number" name="floor" placeholder="" class="form-control" value="">
							<small class="help-block-none">Поверх</small>
						</div>	
						<div class="col-md-2">
							<input type="number" name="floors" placeholder="" class="form-control" value="">
			...
			<div class="form-group row">
				...
				<div class="col-sm-9  select">
					<select multiple=""  name="sale_status" class="form-control" size="2" required>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<div class="row">
						<div class="col-md-3">
							<input type="text" name="start_price"  placeholder="" class="form-control" value="" required>
							<small class="help-block-none">Стартова ціна <span>*</span></small>
						</div>
						<div class="col-md-3">
							<input type="text" name="current_price"  placeholder="" class="form-control" value="" required>
							<small class="help-block-none">Поточна ціна <span>*</span></small>
						</div>
						<div class="col-md-3">
							<input type="text" name="hot_price"  placeholder="" class="form-control" value="">
							<small class="help-block-none">Ціна викупу <span>*</span></small>
						</div>
						<div class="col-md-3">
							<input type="date" name="date_off"  placeholder="" class="form-control" value="">
