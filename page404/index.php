    ...
    <section id="wrapper" class="container-fluid">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <p class="text-muted m-t-30 m-b-30">ЩОБ ПОБАЧИТИ ВМІСТ ДАНОЇ СТОРІНКИ ПОТРІБНО АВТОРИЗУВАТИСЬ</p>
                <a href="<?php echo "../" . $objects->buildLink('login'); ?> " class="btn btn-danger btn-rounded m-b-40">Авторизуватись</a> </div>
